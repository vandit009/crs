					...
					<div class="span12">
						<div class="widget">
							<div class="widget-title">
								<h4>
									<i class="icon-globe"></i>SEARCH COURSE
								</h4>
												...
												<c:forEach items="${sessionScope.search}" var="j">
													<tr>
														...
														<td><a class="btn btn-success"
															href="<%=request.getContextPath() %>/CourseServlet?flag1=edit&id=${j.id}">Edit</a></td>
														<td><a class="btn btn-success"
															href="<%=request.getContextPath() %>/CourseServlet?flag1=delete&id=${j.id}">Delete</a></td>
													</tr>
												</c:forEach>
											</tbody>
