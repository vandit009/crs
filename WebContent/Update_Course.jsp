...
function check()
	...
	{
		document.getElementById("CourseName1").style.display = "";
...
function hide() 
{
	...
	if (document.getElementById("CourseName").value != "") 
	{
		document.getElementById("CourseName1").style.display = "none";
		document.getElementById("CourseName").style.border = "1px solid Blue";
	}
	if (document.getElementById("desc").value != "") 
	{
					...
					<div class="span12">
						<div class="widget">
							<div class="widget-title">
								<h4>
									<i class="icon-globe"></i>UPDATE COURSE
								</h4>
							...
							<div class="widget-body">
								<form name="add_cat" class="form-horizontal"
									action="<%=request.getContextPath()%>/CourseServlet"
									method="post">
									...
									<div class="well" style="padding-bottom: 20px; margin: 0;">
										...
										<div class="control-group">
												...
												<div class="controls"
													...
													</select><span align="center" id="span2"
											...
											<div class="control-group">
												<label class="control-label" id="a">Course Name</label> <input
													type="hidden" name="id" value="${i.id}" />
												<div class="controls"
													style="width: 300px; padding-bottom: 5px;">
													<input class="span12" id="CourseName" onkeyup="hide()" required="true" name="course" type="text" value="${i.course}"  />
													 <span align="center" id="CourseName1" style="margin-top: 50px; color: red; font-size: 15px; border-radius: 6px 6px 6px 6px; display: none">Please Enter Course Name</span>
												</div>
											</div>
											...
											<div class="control-group">
												<label class="control-label" id="b">Course
													Description</label>
												<div class="controls">
