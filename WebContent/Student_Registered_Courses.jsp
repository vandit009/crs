								...
								<table
											...
											<thead>
												...
												<c:forEach items="${sessionScope.search}" var="j">
													...
													<tr>
														<td>${j.id}</td>
														<td>${j.s1.s1.department}</td>
														<td>${j.s1.s2.code}</td>
														<td>${j.s1.s2.course}</td>
														<td>${j.s1.startdate}</td>
														<td>${j.s1.enddate}</td>
														<td>${j.s1.day}</td>
														<td>${j.s1.st}</td>
														<td>${j.s1.et}</td>														
														
														<td><a class="btn btn-success" href="<%=request.getContextPath() %>/StudentCourseRegistrationServlet?flag1=delete&id=${j.id}">Drop</a></td>
